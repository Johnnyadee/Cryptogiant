                                ...
                                <div class="nk-block-between-md g-4">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="nk-block-tools gx-3">
                                            <li><a href="{{ url('user/trade') }}" class="btn btn-primary"><span>Deposit</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                                            <li><a href="{{ url('user/trade') }}" class="btn btn-white btn-light"><span>Buy / Sell</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="nk-wg7">
                                                            <div class="nk-wg7-stats">
                                                                ...
                                                                <div class="number-lg amount">{{ Auth::user()->balance }}</div>
                                                            </div>
                                                            ...
                                                            <div class="nk-wg7-foot">
                                                                <span class="nk-wg7-note">Last activity at <span>{{ Auth::user()->created_at }}</span></span>
                                                            </div>
                                                        </div><!-- .nk-wg7 -->
                                                    </div><!-- .card-inner -->
                                                </div><!-- .card -->
                                        ...
                                        <div class="nk-block">
                                            <div class="nk-block-head-xs">
                                                <div class="nk-block-between-md g-2">
                                                    ...
                                                    <div class="nk-block-head-content">
                                                        <a class="link link-primary">Crypto-Giant</a>
                                                    </div>
                                                </div>
                                            </div><!-- .nk-block-head -->
                                            <div class="row g-2">
                                                        ...
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="#">
                                                                ...
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">{{ Auth::user()->getBtcValue() }}<span class="currency currency-btc">BTC</span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card bg-light">
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="#">
                                                                ...
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">{{ Auth::user()->getLcValue() }}<span class="currency currency-eth">LTC</span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="nk-refwg-invite card-inner">
                                            ...
                                            <div class="nk-refwg-url">
                                                <div class="form-control-wrap">
                                                    <div class="form-clip clipboard-init" data-clipboard-target="#refUrl" data-success="Copied" data-text="Copy Code"><em class="clipboard-icon icon ni ni-copy"></em> <span class="clipboard-text">Copy Code</span></div>
                                                    <div class="form-icon">
                                                        <em class="icon ni ni-link-alt"></em>
                                                    </div>
                                                    <input type="text" class="form-control copy-text" id="refUrl" value="4945KD48CG">
                                                </div>
                                            </div>
                                        </div><!-- .nk-refwg-invite -->
                                    ...
                                    <div class="card-inner card-inner-lg">
                                        <div class="align-center flex-wrap flex-md-nowrap g-4">
                                            ...
                                            <div class="nk-block-content flex-shrink-0">
                                                <a href="{{ url('faq-and-support') }}" class="btn btn-lg btn-outline-primary">Get Support Now</a>
                                            </div>
                                        </div>
                                    </div><!-- .card-inner -->
                                </div><!-- .card -->
