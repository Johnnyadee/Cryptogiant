                                ...
                                <div class="nk-block-des">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="nk-block-tools gx-3">
                                            ...
                                            <li><a href="{{ url('user/trade') }}" class="btn btn-primary"><span>Send</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                                            <li><a href="{{ url('user/trade') }}" class="btn btn-dim btn-outline-light"><span>Withdraw</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="card card-bordered is-dark">
                                            <div class="nk-wgw">
                                                ...
                                                <div class="nk-wgw-actions">
                                                    <ul>
                                                        <li><a href="{{ url('user/trade') }}"><em class="icon ni ni-arrow-up-right"></em> <span>Send</span></a></li>
                                                        <li><a href="{{ url('user/trade') }}"><em class="icon ni ni-arrow-down-left"></em><span>Receive</span></a></li>
                                        ...
                                        <div class="card card-bordered">
                                            <div class="nk-wgw">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <div class="nk-wgw-balance">
                                                        <div class="amount">{{ Auth::user()->getDcValue() }}<span class="currency currency-eth">DGC</span></div>
                                                        <div class="amount-sm">0.00<span class="currency currency-usd">NGN</span></div>
