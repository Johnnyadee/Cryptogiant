                            ...
                            <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                <div class="nk-block-head-content text-center">
                                    ...
                                    <div class="nk-block-des">
                                        <p>Welcome to our <strong>Crypto-Giant</strong>. You are few steps away to complete your profile. These are required to buy and sell on our platform! Let’s start!</p>
                                    </div>
                                </div>
                            </div><!-- .nk-block-head -->
                            <div class="nk-block">
                                            ...
                                            <div class="card-inner card-inner-lg h-100">
                                                <div class="align-center flex-wrap flex-md-nowrap g-3 h-100">
                                                    ...
                                                    <div class="nk-block-content">
                                                        ...
                                                        <a href="{{ url('user/kyc-profile') }}" class="btn btn-lg btn-primary">Get Started</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- .col -->
