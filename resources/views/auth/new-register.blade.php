                ...
                <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                    <div class="slider-init" data-slick='{"dots":true, "arrows":false}'>
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="{{ asset('main') }}/images/slides/promo-a.png" srcset="{{ asset('main') }}/images/slides/promo-a2x.png 2x" alt="">
                                </div>
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="{{ asset('main') }}/images/slides/promo-b.png" srcset="{{ asset('main') }}/images/slides/promo-b2x.png 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                                    <h4>Crypto-Giant</h4>
                                    <p>You can start to create your products easily with its user-friendly design & most completed responsive layout.</p>
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="{{ asset('main') }}/images/slides/promo-c.png" srcset="{{ asset('main') }}/images/slides/promo-c2x.png 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                                    <h4>Crypto-Giant</h4>
                                    <p>You can start to create your products easily with its user-friendly design & most completed responsive layout.</p>
